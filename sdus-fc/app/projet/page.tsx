...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "L'excellence au service de la masse : philosophie, piliers et ambitions de l'UFSD.",
    url: '/projet',
    type: 'website',
  },
};
        ...
        <div className="mx-auto max-w-7xl px-5 sm:px-6">
          ...
          <Reveal>
            <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:mt-14">
              <Link
                href="/club"
                className="group flex items-center justify-between gap-4 rounded-[1.15rem] border border-cloud bg-mist p-5 transition hover:-translate-y-1 hover:border-accent sm:p-6"
              >
                <span>
                  <span className="display-sm text-lg italic text-navy">Gouvernance & organigramme</span>
                  <span className="mt-1 block text-sm text-slate-soft">L&apos;équipe dirigeante et les pôles du club.</span>
                </span>
                <Icon name="arrow-right" size={22} strokeWidth={2.2} className="shrink-0 text-flame transition-transform duration-300 group-hover:translate-x-1" />
              </Link>
              <Link
                href="/partenaires"
                className="group flex items-center justify-between gap-4 rounded-[1.15rem] border border-cloud bg-mist p-5 transition hover:-translate-y-1 hover:border-accent sm:p-6"
              >
                <span>
                  <span className="display-sm text-lg italic text-navy">Territoire & partenariats</span>
                  <span className="mt-1 block text-sm text-slate-soft">Image, communication et réseau de partenaires.</span>
                </span>
                <Icon name="arrow-right" size={22} strokeWidth={2.2} className="shrink-0 text-flame transition-transform duration-300 group-hover:translate-x-1" />
              </Link>
            </div>
