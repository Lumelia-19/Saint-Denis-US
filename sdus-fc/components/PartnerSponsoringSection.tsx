...
export default function PartnerSponsoringSection() {
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex max-w-[1500px] flex-col px-5 sm:px-8 lg:block lg:px-10 min-[1400px]:px-16">
        ...
        <Reveal delay={0.04} className="lg:absolute lg:left-[8%] lg:top-[34%] lg:w-[180px]">
          <div className="max-w-xs lg:mb-0">
            ...
            <p className="nums text-[2rem] sm:text-5xl lg:text-6xl font-black italic leading-none text-royal" style={{ fontFamily: 'var(--font-display)' }}>
              500<span className="text-flame">+</span>
            </p>
            <p className="display-sm mt-1 text-base sm:text-xl lg:text-2xl italic text-flame">Jeunes licenciés</p>
        ...
        <Reveal delay={0.1} className="lg:absolute lg:right-[8%] lg:top-[34%] lg:w-[180px]">
          <div className="max-w-xs lg:mb-0 lg:ml-auto">
            ...
            <p className="display-sm mt-1 text-base sm:text-xl lg:text-2xl italic text-flame">Au cœur de Saint-Denis</p>
            <p className="mt-3 hidden text-sm leading-relaxed text-deep/78 sm:block sm:mt-4">
        ...
        <div className="relative order-1 mx-auto flex w-full max-w-[640px] flex-col items-center justify-center py-6 text-center lg:order-none lg:h-[640px] lg:w-[640px] lg:py-0">
          ...
          {NODES.map((node) => (
            ...
            >
              ...
              <p className="display-sm whitespace-pre-line text-[0.82rem] sm:text-sm italic leading-[1] text-royal lg:text-[0.78rem]">
                {node.title}
              </p>
            </div>
          ))}
        ...
        <div className="order-3 mx-auto mt-8 grid grid-cols-1 max-w-[920px] gap-3 sm:grid-cols-2 sm:gap-5 lg:order-none lg:mt-20 lg:grid-cols-3 lg:gap-6">
          {BENEFITS.map((item, i) => (
            <Reveal key={item.title} delay={0.32 + i * 0.08}>
              <Link
                href="/partenaires"
                className="group relative block h-full min-h-[120px] overflow-hidden rounded-[1rem] border border-royal/14 bg-white/96 p-4 shadow-[0_22px_54px_-34px_rgba(13,27,75,0.65)] backdrop-blur transition duration-300 hover:-translate-y-1 sm:min-h-[180px] sm:p-6"
              >
