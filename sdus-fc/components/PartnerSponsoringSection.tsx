      ...
      <div className="relative z-10 mx-auto max-w-[1500px] px-5 sm:px-8 lg:px-10 min-[1400px]:px-16">
        ...
        <div className="relative mx-auto flex w-full max-w-[640px] flex-col items-center justify-center py-8 text-center lg:h-[640px] lg:w-[640px] lg:py-0">
          ...
          <div className="relative z-20 mx-auto max-w-md pt-2 lg:pt-0">
            <h2 id="partenaires-section-title" className="hero-title text-navy lg:text-[3.6rem]">
              Partenaires
              <br />
            ...
            <Link href="/partenaires" className="btn-primary group mt-6 min-w-52">
              Devenir partenaire
              <Icon
                name="arrow-right"
                size={18}
        ...
        <div className="mx-auto mt-12 grid max-w-[920px] gap-5 sm:grid-cols-3 lg:mt-20 lg:gap-6">
          {BENEFITS.map((item, i) => (
            <Reveal key={item.title} delay={0.32 + i * 0.08}>
              <Link
                href="/partenaires"
                className="group relative block h-full min-h-[180px] overflow-hidden rounded-2xl border border-royal/14 bg-panel/80 p-6 shadow-[0_22px_54px_-34px_rgba(13,27,75,0.65)] backdrop-blur transition duration-300 hover:-translate-y-1"
              >
